...
<h3><a href="https://bit.ly/Suriyaa"><img src="{{ site.url }}assets/img/logo.png" alt="Suriyaa Kudo" width="216" height="36" border="0"></a> Newsletter
</h3>
<p>Hello ' . $name . ',</p>
<p>You can make this out to be just like most any web page or design format you require using HTML and CSS.</p>
<p>~Suriyaa Kudo</p>
<hr>
<p>To opt out of receiving this newsletter,  <a href="{{ site.url }}newsletter/optout.php?e=' . $email . '">click here</a> and I will remove you from the listing immediately.</p>
</body>
</html>';
    $subject = "Suriyaa Kudo Newsletter";
    $headers  = "From:newsletter@suriyaa.isc\r\n";
...
if ($numRows == 0) { // $numRows is set on line 4 using the existing query
     ...
     $hdr  = "From:newsletter@suriyaa.isc\r\n";
