 ...
 */
const CLIENT_ID = '619262515557-o6uu0uboe9kga4f1j04tdvim5hk6rvih.apps.googleusercontent.com';

/**
 * Replace this with the client secret you got from the Google APIs console.
 */
const CLIENT_SECRET = 'jrajLpXPcUTwyhGhNd_J_eHu';

/**
 * Optionally replace this with your application's name.
 */
const APPLICATION_NAME = "Suriyaa Kudo";
